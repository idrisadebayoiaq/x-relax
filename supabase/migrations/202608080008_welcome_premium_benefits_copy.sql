-- Welcome copy mentions Premium benefits for new signups
...
begin
  ...
  if final_role = 'creator' then
    ...
    welcome_body := format(
      'Hi %s — breathe easy. Explore calming sounds and save favourites. Free accounts unlock 7 sounds a day. Upgrade to Premium anytime for unlimited listening, loop, Sleep Time, downloads, Mix Studio, and an ad-free experience.',
      display
    );
  end if;
