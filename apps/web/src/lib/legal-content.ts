...
• Mix Studio: layered sound choices, volumes, and rendered mix audio you save to your library
• First-party analytics: anonymous session id, page path, and app-open or APK-download events. We do not use advertising networks.
• Payments: manual payment requests, proof images, and subscription status
• Device: push notification tokens when you opt in; basic diagnostics when enabled

2. How we use data
• Provide playback, library, Premium, Sleep Time, Mix Studio, and creator features
• Render and store your saved mixes as a single audio file in your personal library
...
• Send in-app and push notifications when enabled (welcome, payments, creator updates, announcements)
...
• You may delete playlists, favourites, downloads, and saved mixes from Library in the app
• You may turn push notifications off anytime in Settings
• You may request account deletion in Settings or by contacting support
...
1. Accounts
• You must agree to these Terms and our Privacy Policy before creating an account
...
3. Mix Studio
• Mix Studio lets you layer published sounds, adjust volumes, and save a personal mix
• When you play then save, we render your session into one audio file for your library
• Saved mixes are for personal listening within X-Relax unless you are a Creator with separate publishing rights
• You may delete saved mixes from your library at any time
