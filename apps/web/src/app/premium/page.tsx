    ...
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-muted mt-2">
          {access ? formatPremiumCoverage(access) : isPremium
